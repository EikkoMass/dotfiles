...
sudo pacman -Syu git python python3 wget curl vlc kitty gedit meson ninja nautilus arandr cmake htop neofetch lightdm lightdm-webkit2-greeter krita gimp
